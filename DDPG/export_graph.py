...
plt.show()
namefig = "plot/scores_improved_DDPG_episodes" + str(data.shape[0]) + ".jpg"
...
plt.show()
namefig = "plot/distances_improved_DDPG_episodes" + str(data.shape[0]) + ".jpg"
fig.savefig(namefig, dpi=300)
...
plt.show()
namefig = "plot/actor_loss_improved_DDPG_episodes" + str(data.shape[0]) + ".jpg"
fig.savefig(namefig, dpi=300)

fig = plt.figure()
ax = fig.add_subplot(111)
x = np.arange(1, len(critic_losses) + 1)
y = critic_losses
plt.plot(x, y)
...
plt.show()
namefig = "plot/critic_loss_improved_DDPG_episodes" + str(data.shape[0]) + ".jpg"
fig.savefig(namefig, dpi=300)
...
plt.show()
namefig = "plot/mean_scores_improved_DDPG_episodes" + str(data.shape[0]) + ".jpg"
fig.savefig(namefig, dpi=300)
...
plt.show()
namefig = "plot/mean_distances_improved_DDPG_episodes" + str(data.shape[0]) + ".jpg"
fig.savefig(namefig, dpi=300)
